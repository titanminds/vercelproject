...
export default function Service_details_page_two() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Trading Account">
                                ...
                                <div className="sidebar-widget category-widget">
                                    ...
                                    <div className="widget-content">
                                        <ul className="category-list clearfix">
                                            ...
                                            <li><Link href="/service-details-2" className="current"><span>Trading Account</span><i className="flaticon-right-arrow-1"></i></Link></li>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div className="account-details-content">
                                <div className="content-one">
                                    <h2>Introducing Trading Account</h2>
                                ...
                                <div className="content-two">
                                    <div className="text-box">
                                        <h2>Benefits of Trading Account</h2>
