...
export default function Trader_one() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="MetaTrader 4">
                        ...
                        <div className="col-lg-6 col-md-12 col-sm-12 content-column">
                            <div className="content-box">
                                <div className="sec-title">
                                    ...
                                    <h2>MT4 platform clear & useful videos</h2>
                                </div>
                                <div className="text-box">
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-4 col-md-12 col-sm-12 image-column">
                                <div className="image-box">
                                    ...
                                    <span className="big-text">MT4</span>
                                </div>
                            </div>
            ...
            <section className="cta-style-two bg-color-1 centred">
                ...
                <div className="auto-container">
                    <div className="inner-box">
                        <h2>Not sure if MT4 is for you?</h2>
