...
export default function Service_details_page_four() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Monitoring & Support">
                                ...
                                <div className="sidebar-widget category-widget">
                                    ...
                                    <div className="widget-content">
                                        <ul className="category-list clearfix">
                                            ...
                                            <li><Link href="/service-details-4" className="current"><span>Monitoring & Support</span><i className="flaticon-right-arrow-1"></i></Link></li>
                                            <li><Link href="/service-details-5"><span>Education & Training</span><i className="flaticon-right-arrow-1"></i></Link></li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div className="account-details-content">
                                <div className="content-one">
                                    <h2>Introducing Monitoring & Support</h2>
                                    ...
                                    <figure className="image-box"><img src="assets/images/resource/account-8.jpg" alt=""/></figure>
                                </div>
                                <div className="content-two">
                                    <div className="text-box">
                                        <h2>Benefits of Monitoring & Support</h2>
