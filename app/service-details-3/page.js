...
export default function Service_details_page_three() {
    ...
    return (
        <div className="boxed_wrapper">
            <Layout headerStyle={1} footerStyle={1} breadcrumbTitle="Platforms & Tools">
                                ...
                                <div className="sidebar-widget category-widget">
                                    ...
                                    <div className="widget-content">
                                        <ul className="category-list clearfix">
                                            ...
                                            <li><Link href="/service-details-3" className="current"><span>Platforms & Tools</span><i className="flaticon-right-arrow-1"></i></Link></li>
                        ...
                        <div className="col-lg-8 col-md-12 col-sm-12 content-side">
                            <div className="account-details-content">
                                <div className="content-one">
                                    <h2>Introducing Platforms & Tools</h2>
                                ...
                                <div className="content-two">
                                    <div className="text-box">
                                        <h2>Benefits of Platforms & Tools</h2>
